...
Multi-node FL training with DP-SGD, secure aggregation

### Motivation

This project addresses the growing need for privacy-preserving ml research. Current solutions either lack GPU acceleration or are locked to proprietary platforms. This toolkit provides an open-source, ROCm-compatible implementation that runs efficiently on AMD Instinct MI300X accelerators.
...
```bash
git clone https://github.com/yuki-tanaka-hpc/federated-learning-framework.git
...
```python
from federated_learning_framework import Pipeline
